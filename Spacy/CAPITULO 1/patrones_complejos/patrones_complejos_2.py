# Escribe un patrón que únicamente encuentre formas de “descargar” (tokens con el lemma “descargar”) seguido por un token 
# que tenga la etiqueta gramatical "PROPN" (proper noun).
